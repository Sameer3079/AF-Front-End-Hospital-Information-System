                ...
                <form>
                    ...
                    <div className="form-group col-md-4">
                     ...
                     <div className="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" onChange={(event) => this.eTypeChange(event)} placeholder="Enter employee type" name="eType" />
                        {
                            this.state.eTypeError? <small  style={{color:"red"}} className="animated zoomIn form-text text-muted">
                                {this.state.eTypeError}
                                    </small>
                                    :""
                        }
                    </div>
